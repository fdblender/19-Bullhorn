...
drop sequence bhuser_seq;
drop sequence bhpost_seq;
create sequence bhuser_seq start with 100 increment by 1 nocache;
create sequence bhpost_seq start with 100 increment by 1 nocache;
...
--------------------------------------------------------
 ALTER TABLE "ORA1"."BHPOST" ADD CONSTRAINT "FK_BHUSERID" FOREIGN KEY ("BHUSERID")
      ...
      select b from Bhpost b "
                + "where b.posttext like :search
                
select * from bhpost where posttext like '%user1%';
